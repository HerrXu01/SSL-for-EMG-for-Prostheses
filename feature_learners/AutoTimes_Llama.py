...
@registry.register_feature_learner("AutoTimesLlama")
class AutoTimesLlama(nn.Module):
    def __init__(
        self,
        configs,
        mode='pretrain'  # supports pretrain and extract
    ):
        super(AutoTimesLlama, self).__init__()
    ...
    def forecast(self, x_enc, x_mark_enc):
        ...
        if self.mix:
            ...
            x_mark_enc = x_mark_enc / x_mark_enc.norm(dim=1, keepdim=True)
